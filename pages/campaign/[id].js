...
export async function getServerSideProps({ params }) {
  ...
  return {
    props: {
      ...
      target: summary[8],
      ETHPrice,
      cmpyTokenAddress:summary[9],
      currencyName:summary[10],
      currencySymbol:summary[11]
    },
  };
}
          ...
          >
            <Stack spacing={{ base: 6 }}>
              ...
              <Link
                ...
                isExternal
              >
                Transaction History<ExternalLinkIcon mx="2px" />
              </Link>
            </Stack>
            ...
            <Box>
              ...
              >
                <Heading
                  ...
                  color={useColorModeValue("#F27920", "teal.200")}
                >
                  Commit Now!
                </Heading>
                    ...
                    <FormControl id="value">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          step="any"
                          min="0"
                          placeholder="  Type the Ether need to contribute"
                        />{" "}
                    ...
                    <Stack spacing={10}>
                      {wallet.status === "connected" ? (
                        <Button
                          ...
                          mt={4}
                          w={"full"}
                          bgGradient="linear(to-r, rgba(210,80,40,0.9),#F27920)"
                          color={"white"}
                          _hover={{
                            bgGradient: "linear(to-r, rgba(210,80,40,0.6),#F27920)",
                            boxShadow: "xl",
                          }}
